...
protección deducidos contra la retención de las devoluciones anuales del Impuesto a la Renta que
practica la \tgr{} para cobrar el CAE (facultad del artículo 17 de la \Lcae{}), sosteniendo que esa
retención \destacar{no configura acto arbitrario ni ilegal}. El criterio se respalda en la \csup{}
---\rol{55.090-2024} y \rol{54.802-2024}--- que precisó un matiz de gran importancia práctica: aun
cuando hubiere \destacar{prescrito la acción ejecutiva del banco}, el Fisco conserva de manera
autónoma el derecho sustantivo a retener las devoluciones tributarias para pagar el crédito
garantizado.\verificar{Individualizar los roles y fechas de la Duodécima Sala de Concepción y
cotejar los considerandos de los Roles CS 55.090-2024 y 54.802-2024 contra los fallos oficiales.}

\begin{alerta}[La prescripción del banco no libera de la retención fiscal]
Es un punto que sorprende al deudor: aunque su banco ya no pueda ejecutarlo por prescripción, la
\tgr{} puede seguir reteniéndole la devolución de impuestos para pagar el CAE, porque su derecho a
retener es autónomo del del banco. Advertirlo forma parte del deber de información: el discharge no
detiene esta retención, y la prescripción de la acción bancaria tampoco.
\end{alerta}
