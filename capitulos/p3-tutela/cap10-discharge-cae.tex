...
La \ca{Concepción}, en fallos unánimes de su Segunda Sala, ha \destacar{rechazado} recursos de
protección de estudiantes contra la suspensión del beneficio del CAE decretada por la Comisión
Administradora del Sistema de Créditos tras acogerse el deudor a una liquidación voluntaria,
estimando que esa suspensión administrativa no constituye acto ilegal ni
arbitrario.\verificar{Roles y fechas exactos de la Segunda Sala de la CA de Concepción por
individualizar: no localizados en fuentes abiertas; rastrear en Westlaw/Microjuris con los
descriptores «CA Concepción» + «Segunda Sala» + «Crédito con Aval del Estado» + «liquidación».}
