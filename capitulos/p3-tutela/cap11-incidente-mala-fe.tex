...
\subsection{Las primeras resoluciones y la apelabilidad del incidente}

Desde la entrada en vigencia de la \Lreforma{} (mayo de 2023), los juzgados civiles han comenzado a
perfilar la figura. Un fallo pionero del \destacar{28.\textsuperscript{o} Juzgado Civil de Santiago}
acogió el incidente contra una sociedad deudora que había omitido entregar los libros contables,
ocultado los saldos en caja y no rendido cuenta de una partida obligatoria; y el
\destacar{2.\textsuperscript{o} Juzgado Civil de Concepción} (Rol \rol{C-891-2021}) ha sentado
criterios sobre la delimitación de la conducta del deudor previa a la
apertura.\verificar{Individualizar el rol del fallo del 28.º Juzgado Civil de Santiago y cotejar el
Rol C-891-2021 contra los expedientes oficiales.}

Una cuestión procesal relevante es la \destacar{apelabilidad} de la resolución que falla el
incidente. Como el \art{169 A} no contempla expresamente el recurso, se ha acudido a la aplicación
supletoria del \cpc{} que autoriza el \art{11}. La \csup{}, aunque en un contexto distinto ---la
apelabilidad de la resolución que denegaba la exclusión de un crédito con garantía estatal, en
\emph{Henríquez Garay} (\rol{4074-2018})---, sentó la doctrina general de que procede la apelación,
por vía supletoria, contra la providencia que produce una \destacar{alteración sustancial} del
estatuto del deudor o de los acreedores no reparable en la sentencia de término. Ese razonamiento se
proyecta con naturalidad sobre la resolución del incidente de mala fe, que decide nada menos que el
acceso del deudor a la extinción de saldos.\verificar{El fallo Henríquez Garay (CS 4074-2018) versa
sobre la apelabilidad en materia de CAE; se invoca aquí por analogía. Cotejar su considerando y
confirmar la existencia de jurisprudencia que aplique el criterio específicamente al incidente del
art. 169 A.}
...
El \destacar{Tribunal Constitucional} ha fijado el estándar aplicable. En los requerimientos
\rol{12.539-2021-INA} y \rol{12.527-2021-INA}, de 3 de noviembre de 2022
\parencite{juris-tc-nebisinidem}, precisó que la clave está en el \destacar{bien jurídico
protegido}: si ambas sanciones responden al mismo bien jurídico hay doble punición; si obedecen a
bienes jurídicos diferentes, no hay infracción a la garantía, sino la respuesta del ordenamiento
frente a hechos de diversa naturaleza dentro del mismo acto reprochado. Los requerimientos fueron
rechazados.\verificar{Los Roles TC 12.539-2021-INA y 12.527-2021-INA no pudieron confirmarse en
texto completo en fuentes abiertas; cotejar carátula, fecha y considerando en el buscador del
Tribunal Constitucional antes de imprimir (el estándar del bien jurídico como criterio del \emph{ne
bis in idem} sí es doctrina constitucional asentada, con independencia de estos roles).}

La doctrina, con todo, ha advertido la fricción que subsiste. \textcite{alarcon-mala-fe} subraya
que la sanción del inciso cuarto del \art{169 A} tiene naturaleza materialmente punitiva, de modo
que su acumulación con la pena criminal del artículo 463 exige un test de proporcionalidad y de
identidad de fundamento antes de aplicarse en cascada ---y cuestiona, además, la
\destacar{graduación parcial} de la descarga: la mala fe sería un concepto indivisible, de suerte
que la denegación debería ser categórica y no admitir una «mala fe a medias»---. Por su parte,
\textcite{goldenberg-gravedad-hechos} lee la «gravedad de los hechos» desde la transparencia
patrimonial y la proporcionalidad, insistiendo en que el reproche civil concursal y el penal
responden a bienes jurídicos distintos ---la integridad de la masa y la fe pública---, lo que
atenúa, pero no disuelve, la objeción. Aplicado el criterio del Tribunal Constitucional, la
defensa debe forzar al sentenciador a \emph{identificar} el bien jurídico de cada sanción: es ahí
donde se juega la garantía.
