...
\begin{enumerate}
  ...
  indicar, además, su participación en sociedades, comunidades y comunidades hereditarias; y,
  si tributa en renta efectiva según contabilidad completa, acompañar copia del inventario.
  \item \textbf{Documentación de dominio} de los bienes registrables ---en particular, el
  certificado de dominio vigente del Conservador para los inmuebles y el de anotaciones vigentes
  del Registro Civil para los vehículos---.
  \item \textbf{Lista de bienes legalmente excluidos} de la liquidación, si los hubiere.
  \item \textbf{Relación de juicios pendientes}.
  \item \textbf{Estado de deudas}, con nombre, domicilio y datos de contacto de los acreedores y
  la naturaleza de sus créditos.
  \item \textbf{Nómina de trabajadores} ---cualquiera sea su situación contractual--- con las
  prestaciones laborales y previsionales adeudadas y los fueros, incluyendo el estado de pago de
  las cotizaciones de seguridad social.
  \item \textbf{Último balance}, si el deudor lleva contabilidad completa.
  ...
  (los bancos deben entregarlas en cinco días) e informes de deuda de la \cmf{}.
  \item \textbf{Declaración jurada} de que los antecedentes acompañados son completos y
  fehacientes.
\end{enumerate}

El tribunal \destacar{podrá denegar} el curso de la solicitud si estos requisitos no se cumplen.
...
menciones de los artículos 169 y 170 del \cpc{} debe contener:
...
\begin{enumerate}
  ...
  \destacar{orden de incautar todos los bienes} del deudor, con auxilio de la fuerza pública.
  \item La orden a las \destacar{oficinas de correos} de entregar al liquidador la
  correspondencia dirigida al deudor.
  \item La \destacar{orden de acumular} al procedimiento todos los juicios pendientes contra el
  deudor que puedan afectar sus bienes, seguidos ante cualquier tribunal, salvo las excepciones
  legales.
  \item La \destacar{advertencia al público} de no pagar ni entregar mercaderías al deudor ---bajo
  pena de nulidad--- y la orden de poner a disposición del liquidador, en tercero día, los bienes
  o documentos del deudor que se tengan.
  \item El aviso a los acreedores residentes en Chile de que tienen \destacar{treinta días} desde
  la publicación para presentarse con los documentos de sus créditos, bajo apercibimiento de ser
  afectados por el juicio sin nueva citación.
  \item La orden de notificar la resolución a los acreedores fuera del territorio de la República.
  \item La orden de \destacar{inscribir la resolución} en los conservadores de bienes raíces de
  cada inmueble y de anotarla al margen de la inscripción social en el Registro de Comercio.
  \item La indicación precisa del lugar, día y hora de la \destacar{primera junta de acreedores}.
\end{enumerate}

La resolución se notifica por su publicación en el \boletin{} y sólo admite apelación en el solo
efecto devolutivo, con preferencia para su vista y fallo; contra la sentencia de segunda instancia
...
El \art{165} precisa el contenido del \destacar{inventario}: un registro de los libros,
correspondencia y documentos del deudor; la individualización de los bienes ---con constancia
especial del estado de conservación de maquinarias, útiles y equipos---; y, de particular
relevancia forense, \destacar{la identificación de los bienes sujetos a leasing y de todos
aquellos que estén en poder del deudor en una calidad distinta a la de dueño}. Este último
numeral es el filtro que separa la masa activa realizable de los bienes ajenos que deberán
restituirse por la vía de la tercería o de la reivindicación.

El \art{166} impone la \destacar{publicidad} del acta: el liquidador debe agregarla al
expediente y publicarla en el \boletin{} a más tardar al quinto día contado desde la última
diligencia, regla que se extiende a las incautaciones posteriores y a las exclusiones de bienes.
Los \art{167} y \art{168} regulan la asesoría al liquidador durante la diligencia: puede hacerse
acompañar por un \destacar{especialista en el giro del deudor} ---cuyos honorarios son gasto de
administración, sujetos a aprobación de la junta inmediatamente posterior--- y por sus
dependientes o asesores de confianza, estos últimos de su cargo exclusivo.

\begin{alerta}[El deber de colaboración del deudor y su apercibimiento]
El \art{169} obliga al deudor a indicar y poner a disposición del liquidador todos sus bienes y
antecedentes, \destacar{bajo apercibimiento de arresto de hasta dos meses o multa de hasta 10
UTM}. Ante su negativa, el deber recae en los administradores; el liquidador puede requerir el
auxilio de la fuerza pública ---basta exhibir copia autorizada de la Resolución de Liquidación al
jefe de turno de Carabineros--- y \destacar{debe} solicitar la declaración de mala fe del
\art{169 A} (capítulo \ref{cap:mala-fe}). La oposición del deudor a la incautación no es un
incidente menor: gatilla, por ley, el incidente de mala fe.
\end{alerta}
...
deudor se acumulan} al procedimiento de liquidación ---y siguen tramitándose según su naturaleza
hasta la sentencia ejecutoriada---, y los posteriores se promueven ante el tribunal del concurso.
El \art{143} exceptúa los juicios ante árbitros, los de arbitraje forzoso y los sometidos a
tribunales especiales.

Los \art{144} a \art{146} regulan la acumulación de los juicios \destacar{ejecutivos} con reglas
propias: en las obligaciones de dar, si \emph{no} hay excepciones opuestas el juicio se
\destacar{suspende} y el ejecutante verifica conforme a las reglas generales; si \emph{hay}
excepciones opuestas, la ejecución continúa su tramitación particular ---asumiendo el liquidador la
representación del deudor--- y el ejecutante verifica \emph{condicionalmente} (\art{144}). Si hay
codemandados distintos del deudor, la ejecución se suspende sólo respecto de éste y continúa contra
los demás con copia del expediente (\art{146}). El \art{147} acumula además los juicios que el
\emph{propio deudor} inició para controvertir los créditos que fundan la liquidación forzosa,
resolviéndose junto con su oposición del \art{121} en un mismo fallo.

\begin{alerta}[Los embargos y precautorias caen con la resolución de liquidación]
De la mayor importancia práctica: el \art{148} dispone que los \destacar{embargos y medidas
precautorias} decretados en juicios contra el deudor, sobre bienes que deban ingresar o realizarse
en el concurso, \destacar{quedan sin efecto desde que se dicta la Resolución de Liquidación}. Sólo
el \emph{liquidador} puede pedir el alzamiento, que el tribunal decreta sin más trámite con el solo
mérito de la resolución. La lógica es que la masa se administra unificadamente: ninguna traba
individual anterior sobrevive. Incluso las cautelares penales del Título \textsc{ix} del Libro
\textsc{ii} del \cpen{} se alzan al comunicar el liquidador la resolución al Juzgado de Garantía
(\art{149}).
\end{alerta}

\begin{foco}[El concurso atrae los litigios del deudor y borra las trabas]
La apertura produce dos efectos combinados: concentra ante un solo tribunal la conflictividad
dispersa del deudor ---salvo las excepciones del \art{143}--- y \destacar{deja sin efecto los
embargos y precautorias} que pesaban sobre sus bienes. Para el acreedor que había logrado embargar,
la resolución de liquidación disuelve esa ventaja individual y lo reconduce al reparto colectivo.
Mapear el estado de cada juicio pendiente ---y de cada traba--- es parte del diagnóstico inicial de
la liquidación.
\end{foco}
...
\subsubsection{Representación, fraccionamiento y las exclusiones al derecho a voto}

La mecánica del voto tiene reglas propias que decantan mayorías. El \art{187} admite que la
asistencia sea personal o por \destacar{mandatario} ---en instrumento público o privado con firma
autorizada---, entendiéndose que el mandatario tiene idénticas facultades que el mandante y por no
escrita toda limitación; se prohíbe otorgar mandato a más de una persona, pero un mismo mandatario
puede representar a varios acreedores. El \art{188} veda el \destacar{fraccionamiento de los
créditos} tras la Resolución de Liquidación: quien lo intente, y quienes representen las porciones,
pierden el derecho a asistir; los que hagan valer porciones dentro de los treinta días anteriores a
la resolución se cuentan como una sola persona con un solo voto. La regla neutraliza la maniobra de
partir un crédito para multiplicar votos o eludir la condición de persona relacionada.

Dos exclusiones cierran el sistema. El \art{191} priva de voto ---y excluye del cómputo del
quórum--- a las \destacar{Personas Relacionadas} con el deudor, y ordena la \destacar{abstención}
del acreedor que tenga un conflicto de interés o un interés distinto del inherente a su calidad de
acreedor respecto de un acuerdo determinado. El \art{192} niega voto por los créditos
\destacar{totalmente pagados} ---por reparto, pago administrativo o incluso por un tercero---,
subsistiendo sólo por el saldo insoluto.

\begin{alerta}[Quién no vota es tan decisivo como quién vota]
Depurar el pasivo votante ---excluir a la persona relacionada del \art{191}, forzar la abstención
del acreedor con conflicto de interés, restar el crédito ya pagado del \art{192} y desbaratar el
fraccionamiento del \art{188}--- puede alterar por completo el resultado de una votación. Es
trabajo previo a la junta, y con frecuencia define el control del procedimiento.
\end{alerta}

\subsubsection{Suspensión y reanudación: la abstención que se suma a la mayoría}

El \art{186} entrega al liquidador la facultad de \destacar{suspender la junta} ---a su solo
arbitrio, una vez tratadas y votadas las materias--- cuando un acuerdo no se adopta por las
abstenciones de los presentes con derecho a voto. La junta se reanuda al segundo día, con dos
reglas de fuerte impacto: se presume de derecho la mantención del quórum de asistencia, y si los
acreedores que se abstuvieron no asisten a la reanudación o vuelven a abstenerse, su voto
\destacar{se adiciona de pleno derecho a la mayoría} obtenida para ese acuerdo. La abstención
reiterada, así, deja de ser neutral: la ley la convierte en apoyo.

\subsubsection{La Comisión de Acreedores}

El \art{202} permite a la junta, con \destacar{Quórum Calificado}, constituir una
\destacar{Comisión de Acreedores} que adopte, con validez general, los acuerdos de su competencia.
Su composición, facultades, duración y procedimiento los fija la propia junta con el mismo quórum.
Es el instrumento de gestión ágil del concurso: evita convocar a la junta plena para cada decisión
y concentra el seguimiento en un núcleo de acreedores activos.
...
\subsubsection{Las costas y la irrenunciabilidad del crédito laboral}

El \art{245} regula el pago de las \destacar{costas personales}: en la liquidación forzosa sólo
proceden las del acreedor peticionario ---con la preferencia del \artcc{2472} \Nro 1---, y en la
voluntaria las del solicitante gozan de la del \Nro 4, sujetas en ambos casos a un límite de
cálculo (2\,\% del crédito hasta 10.000 UF y 1\,\% en el exceso). El \art{246}, por su parte,
declara \destacar{irrenunciables los montos y preferencias de los créditos laborales} de los
números 5 y 8 del \artcc{2472}, salvo por conciliación aprobada por el Juez del Trabajo o
transacción posterior a la sentencia de primera instancia. Es una protección de orden público que
el liquidador no puede soslayar al proponer el reparto.
...
acuerdo de junta por un porcentaje inferior---, reserva previa de los dineros para los gastos del
procedimiento y para los créditos de igual o mejor derecho con impugnación pendiente, y reserva
para los acreedores residentes en el extranjero (\art{252}).

\subsubsection{El procedimiento de objeción del reparto}

El \art{248} articula un contradictorio breve. Presentada la propuesta con su detalle y fórmula de
cálculo, el tribunal la tiene por propuesta y ordena publicarla en el \boletin{}. Los acreedores
que representen al menos el \destacar{20\,\% del pasivo con derecho a voto} pueden objetarla dentro
de \destacar{tres días}: si la objeción es total, el reparto se paraliza hasta su resolución; si es
parcial, se ejecuta en lo no disputado. La resolución que falla la objeción \destacar{no admite
recurso alguno}, y el objetante vencido carga con las costas ---calculadas sobre el monto objetado,
solidariamente si fueron varios--- salvo motivo plausible para litigar. Resuelto o no objetado, el
liquidador distribuye dentro de tercero día, y desde la publicación de la orden de distribución los
acreedores pueden \destacar{reclamarle el pago}. En los créditos subordinados, el subordinado
contribuye a prorrata al pago de su beneficiario.

\subsubsection{Acreedores condicionales, recíprocos y de verificación tardía}

Tres reglas cierran el sistema de repartos. El \art{249} permite al \destacar{acreedor condicional}
pedir la reserva de los fondos que le corresponderían cumplida la condición, o su entrega bajo
caución de restituirlos. El \art{250} resuelve el caso del acreedor que es a la vez deudor de la
masa: las sumas que le correspondan se aplican al pago de su deuda \destacar{aunque no estuviere
vencida}, operando una suerte de compensación concursal. Y el \art{251} regula la
\destacar{verificación extraordinaria}: no suspende los repartos, pero el acreedor que verifica
tarde, una vez reconocido, tiene derecho a ser cubierto \emph{con preferencia} de los fondos aún no
repartidos ---sin poder exigir a los ya pagados devolución alguna---. La tardanza no borra el
crédito, pero sí lo relega a lo que reste.

\begin{practica}[El dividendo no cobrado termina en los Bomberos]
El \art{252} deja en depósito lo reservado a los acreedores residentes en el extranjero hasta el
duplo del término de emplazamiento; y el \art{253} dispone que el dividendo del acreedor que
\destacar{no comparece} a cobrar dentro de tres meses se deposita en arcas fiscales a su orden y,
transcurridos \destacar{tres años} sin cobro, la \tgr{} lo destina íntegramente al
\destacar{Cuerpo de Bomberos}. Conviene advertir al cliente acreedor: un dividendo ignorado no
...
\begin{description}[leftmargin=0pt,style=nextline,font=\sffamily\bfseries]
  ...
  \item[Definitiva] La acuerda la \emph{junta de acreedores}. El \art{233} exige que el acta
  contenga las actividades a continuar, los bienes adscritos, la identificación del administrador
  ---cuyo nombramiento, si recae en el liquidador, requiere \destacar{Quórum Especial}--- y sus
  honorarios. Su \destacar{plazo no puede exceder de un año} desde el acuerdo, prorrogable por una
  sola vez con Quórum Especial (con administrador que ya no puede ser el liquidador); si se acuerda
  la venta como unidad económica, la continuación puede prolongarse lo indispensable para
  concretarla.
\end{description}
...
\subsubsection{El régimen de la continuación definitiva}

Cuando la administra una persona distinta del liquidador, el \art{234} escinde la gestión: el
liquidador conserva la administración de los bienes \emph{no} adscritos y, sobre los adscritos,
retiene las facultades del \art{294} del \cpc{}; las controversias entre ambos las resuelve el
tribunal en audiencia verbal, y la \superir{} fiscaliza al administrador con las mismas potestades
que sobre el liquidador. El administrador rinde informe pormenorizado en cada junta (\art{235}) y
responde \destacar{hasta de la culpa levísima} hasta la aprobación de su cuenta (\art{238}). El
\art{236} añade una regla de oponibilidad: la razón social debe complementarse con la frase
\enquote{en continuación de actividades económicas}, so pena de \destacar{responsabilidad
solidaria} de quienes contraten sin ella.

De particular relevancia es el \art{239}: los créditos nacidos de la continuación \destacar{sólo
pueden perseguirse en los bienes comprendidos en ella} y gozan de la preferencia del \artcc{2472}
\Nro 4; sólo si esos bienes no gravados resultan insuficientes prefieren a los acreedores
hipotecarios, prendarios y retencionarios \emph{que aprobaron} la continuación, con un mecanismo de
prorrata y subrogación. Los excedentes se destinan a pagar a los acreedores del concurso y el
remanente pertenece al deudor.

\subsubsection{El orden de prelación en el pago del pasivo}

El \art{241} remite el pago al orden de prelación del Título XLI del Libro IV del \cc{}, con dos
precisiones de peso: los créditos de \destacar{primera clase} del \artcc{2472} prefieren a todo
privilegio de leyes especiales, y las \destacar{personas relacionadas} cuyos créditos no estén
documentados 90 días antes de la resolución son \destacar{pospuestas aun después de los valistas}.
La subordinación de créditos valistas se respeta si se alegó al verificar o se notificó al
liquidador. Los acreedores de \destacar{segunda clase} y retencionarios pueden optar por ejecutar
individualmente los bienes gravados ante el tribunal del concurso, previa acumulación y asegurando
los créditos de mejor derecho (\art{242}); el liquidador, a su vez, puede exigir la entrega de la
cosa pagando la deuda o depositando su valor. Los \destacar{hipotecarios} se pagan según los
\artcc{2477} a 2480 (\art{243}).
...
\subsection{La resolución de término y la extinción de los saldos insolutos}

El procedimiento culmina con la \destacar{resolución de término}. El \art{254} dispone que,
publicada la resolución que aprobó la Cuenta Final de Administración, el tribunal ---de oficio, a
petición de parte o de la \superir{}--- declara terminada la liquidación, resolución que el
liquidador publica en el \boletin{} dentro de cinco días. Un límite temporal relevante: si está
pendiente el incidente de mala fe del \art{169 A} o alguna acción revocatoria del Capítulo VI, el
tribunal \destacar{no puede dictar el término} hasta que aquéllos queden firmes.

El efecto medular lo produce el \art{255}: firme la resolución de término, se \destacar{extinguen
por el solo ministerio de la ley} los saldos insolutos de las obligaciones contraídas por el deudor
con anterioridad al inicio del procedimiento, y el deudor queda \destacar{rehabilitado} ---cesan
todas las inhabilidades, restricciones y prohibiciones---. Es la consagración legislativa del
\discharge{} y del \freshstart{} en el derecho chileno (capítulo \ref{cap:mala-fe}).

La descarga, sin embargo, no es absoluta. El propio \art{255} exceptúa de la extinción: (i) las
\destacar{deudas de alimentos} legales y la compensación económica de la Ley de Matrimonio Civil, y
(ii) las obligaciones \destacar{derivadas de delitos o cuasidelitos} civiles y penales. Y, de
capital importancia práctica, la extinción \destacar{no beneficia a los garantes}: fiadores,
codeudores solidarios o subsidiarios, avalistas y terceros constituyentes de garantías reales no
pueden invocarla, ni subrogarse, ni exigir reembolso al deudor descargado.

\begin{alerta}[El discharge libera al deudor, no a sus garantes]
La extinción del \art{255} es personalísima del deudor concursado. El acreedor conserva íntegra su
acción contra el fiador o avalista, y éste ---que paga--- no puede repetir contra el deudor
rehabilitado. Para quien avaló a una empresa o a un familiar que luego se liquidó, la deuda sigue
viva. Es una de las advertencias que no puede faltar en la asesoría, tanto al deudor como a quien
lo garantizó.
\end{alerta}
...
\subsection{El desasimiento y sus límites: el apremio no es automático}

El \art{130} priva al deudor de la administración de sus bienes, y los actos que ejecute sobre
ellos con posterioridad a la resolución son inoponibles a la masa. Ese efecto, sin embargo, no
autoriza al liquidador a emplear directamente la coerción personal.

La \csup{}, conociendo de un \destacar{recurso de amparo} en el precedente \emph{Heresmann}
(\rol{20.308-2025}) \parencite{juris-cs-heresmann}, fijó un límite garantista. La \ca{Puerto Montt}
había validado el apercibimiento de arresto solicitado \emph{de plano} por el liquidador; la Corte
Suprema revocó, resolviendo que el \destacar{arresto} del \art{169} ---para forzar la restitución
de activos o el cumplimiento de obligaciones de entrega--- no puede requerirse de plano ni
concederse cuando la exigibilidad de la obligación se encuentra \destacar{controvertida}. Antes de
cualquier apremio resulta imperativo tramitar el procedimiento contradictorio del \art{131}, que
garantiza la bilateralidad de la audiencia; el arresto dispuesto al margen de esa garantía
constituye una detención arbitraria contraria al artículo 7 de la Convención Americana sobre
Derechos Humanos.\verificar{Cotejar los considerandos del Rol 20.308-2025 contra el fallo oficial
(dato proveniente de compilación secundaria).}

\begin{alerta}[El desasimiento no habilita el atajo del arresto]
Frente al liquidador que pide apremio personal por sumas que el deudor discute, la defensa tiene un
argumento de rango convencional: sin incidente previo del \art{131} que fije la exigibilidad, el
arresto es una privación de libertad arbitraria. El desasimiento despoja de la administración, no
del debido proceso.
\end{alerta}

Reunidos los bienes en la masa por el desasimiento, todo acto de disposición, contrato, pago o
transferencia que el deudor ejecute sobre ellos con posterioridad a la resolución adolece de
\destacar{ineficacia frente a la masa}. La jurisprudencia concursal precisa dos rasgos de este
régimen. Primero, la ineficacia opera de forma \destacar{objetiva y de pleno derecho}: no requiere
declaración ni prueba de fraude, a diferencia de las acciones revocatorias del Capítulo VI. Segundo
---y de mayor impacto práctico---, es \destacar{inoponible la buena fe} del tercero adquirente:
como la resolución de liquidación se publica en el \boletin{} y se inscribe en los registros de
propiedad, se presume legalmente el conocimiento del estado de desasimiento, de modo que el tercero
debe restituir el bien a la masa sin poder ampararse en su ignorancia.\verificar{Individualizar
fallos representativos sobre la ineficacia del art. 130 y la inoponibilidad de la buena fe.}

\begin{alerta}[El desasimiento se opone a todos, no sólo al deudor]
La publicidad registral del desasimiento es su fuerza: quien contrata con el deudor liquidado sobre
bienes de la masa no adquiere nada oponible, por más buena fe que invoque. Para el tercero, el deber
de diligencia es consultar el \boletin{} antes de contratar; para el liquidador, inscribir sin
demora la resolución es la actuación que blinda a la masa frente a disposiciones clandestinas.
\end{alerta}

\subsection{Responsabilidad del liquidador en la realización}

El liquidador responde civilmente ante la masa y ante el deudor por los daños que su gestión
ocasione, con el estándar de la \destacar{culpa leve} ---la del buen administrador--- del \art{35}
(capítulo \ref{cap:institucionalidad}). La responsabilidad se persigue tras la cuenta final
(\art{49}) y la jurisprudencia registra condenas indemnizatorias por la
\destacar{pérdida de valor de bienes no realizados oportunamente}, el deterioro de maquinarias bajo
custodia por falta de mantención básica y la enajenación de activos sin las formalidades o
autorizaciones exigidas por la junta o el tribunal.\verificar{Individualizar sentencias
condenatorias contra liquidadores por realización negligente (arts. 35 y 49).}
