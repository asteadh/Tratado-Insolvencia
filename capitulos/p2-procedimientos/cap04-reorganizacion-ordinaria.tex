...
Así lo confirma el caso \falloc{Nutreco con Nova Austral}{}, resuelto por la Primera Sala de la
\csup{} el \destacar{27 de diciembre de 2025} \parencite{juris-cs-nova-austral}. La Corte acogió la
casación en el fondo y dejó sin efecto un acuerdo de reorganización que establecía un
\destacar{trato desigual y arbitrario entre acreedores de una misma clase} ---los garantizados---,
por estimar que la distorsión de la \lat{par condicio creditorum} configura un vicio de ilegalidad
subsumible en la causal 6.\textsuperscript{a} del \art{85}, y ordenó presentar un nuevo plan de
reorganización.\verificar{Individualizar el rol de la causa Nova Austral y cotejar los
