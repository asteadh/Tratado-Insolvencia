...
\begin{alerta}[La «audiencia única» rara vez es única ni enteramente verbal]
La doctrina ha advertido que el apelativo de \emph{única} es más un ideal de concentración que una
descripción \parencite{ruz-derecho-concursal}. La razón es que las incidencias que se promuevan en
ella se rigen supletoriamente por el procedimiento incidental del Título \textsc{ix} del Libro
\textsc{i} del \cpc{}: el \artcpc{89} concede \destacar{tres días} de traslado antes de resolver
---salvo fallo de plano sobre hechos que consten en el proceso---, y el \artcpc{90} abre, si hay
hechos sustanciales controvertidos, un \destacar{término probatorio de ocho días}. Ejercidos esos
traslados o abierta esa prueba, la audiencia deja de agotarse en un solo acto verbal. La facultad
del \art{87} de suspender y continuar la audiencia es, precisamente, el mecanismo por el que la ley
reconoce que la determinación del pasivo puede requerir más de una sesión.
\end{alerta}
...
impugnación son mayoritariamente formales o de cómputo. Sin embargo, el \destacar{numeral 6.\textsuperscript{o}}
---que autoriza impugnar el acuerdo por contener estipulaciones contrarias a la ley--- opera como
la puerta por la que ingresa un control \emph{material} acotado.

Así lo confirma el caso \falloc{Nutreco con Nova Austral}{43.419-2024}, resuelto por la Primera
Sala de la \csup{} el \destacar{26 de septiembre de 2025} ---redactor el Ministro Prado Puga---
\parencite{juris-cs-nova-austral}. En la reorganización de Nova Austral S.A.\ (originada ante el
Juzgado de Letras y Garantía de Porvenir, Rol C-110-2023), el acuerdo pretendía extinguir el
\destacar{100\,\% del crédito y las garantías} de Comercializadora Nutreco mientras reconocía el
pago íntegro y conservaba las prendas de su directo competidor en el suministro de alimento para
salmones. La Corte acogió la casación en el fondo por la causal 6.\textsuperscript{a} del \art{85}:
extinguir unilateralmente un crédito sin contraprestación ni concurrencia de la voluntad del
acreedor lesiona el derecho de propiedad en su esencia (art. 19 \Nro 24 de la Constitución), y la
segmentación en subclases del \art{64} no autoriza a la mayoría a romper la \lat{par condicio
creditorum} sin justificación. Revocó la sentencia de la \ca{Punta Arenas} y ordenó presentar un
nuevo acuerdo libre de discriminación en un plazo de diez días.\verificar{Cotejar los considerandos
del Rol 43.419-2024 contra el fallo oficial (dato proveniente de compilación secundaria).}

\begin{foco}[El control de mérito entra por la causal de ilegalidad]
La Corte no revisa si el acuerdo es económicamente conveniente ---eso es de los acreedores---, pero
sí si su contenido respeta la igualdad intraclase que la ley impone (\art{61} y \art{64}). La
lección práctica para quien redacta un acuerdo: la diferenciación entre acreedores de una misma
clase debe tener fundamento objetivo y constar, o el acuerdo queda expuesto a ser anulado por la
causal 6.\textsuperscript{a} pese a haber reunido los quórums.
\end{foco}
...
\subsection{Impugnación por el voto de acreedores relacionados}

La ley busca evitar que el deudor fabrique mayorías con acreedores de su propio entorno. Las
\destacar{personas relacionadas} ---cónyuge o conviviente, parientes, socios o administradores de
filiales--- quedan \destacar{excluidas del cálculo del quórum} de aprobación (\art{79}), y sus
créditos no documentados noventa días antes del inicio del procedimiento resultan pospuestos
(\art{63}).

El control opera por la vía de la impugnación de la causal 3.\textsuperscript{a} del \art{85}
---falta de personería o incapacidad para votar de quien concurrió a formar el quórum---. Si un
acreedor relacionado participó en la votación y su voto \destacar{alteró el quórum de aprobación},
los acreedores independientes pueden impugnar el acuerdo; verificado que, excluido el relacionado,
el quórum real resulta insuficiente, el tribunal declara sin efecto el acuerdo y abre la
liquidación.\verificar{Individualizar fallos que acojan la impugnación por participación de
personas relacionadas en el quórum (arts. 63, 79 y 85 N.\textsuperscript{o} 3).}

\begin{practica}[Depurar el padrón de votantes antes de la junta]
La defensa del acreedor independiente frente a un acuerdo sospechoso empieza por el
\destacar{mapa de relaciones}: identificar qué votantes son personas relacionadas y recalcular el
quórum sin ellos. Si el acuerdo se sostiene únicamente con esos votos, la impugnación de la causal
3.\textsuperscript{a} del \art{85} tiene un fundamento sólido. Es trabajo de investigación
societaria previo a la junta, no de improvisación posterior.
\end{practica}
