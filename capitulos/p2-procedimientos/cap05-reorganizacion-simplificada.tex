...
\subsection{El control de la «unidad económica» y el abuso de la personalidad jurídica}

Los primeros pronunciamientos posteriores a la \Lreforma{} han centrado el control de admisibilidad
del procedimiento simplificado en un requisito fáctico: que la empresa solicitante constituya una
\destacar{unidad económica real e independiente}. Los tribunales rechazan la admisibilidad cuando
constatan la \destacar{fragmentación artificial} de una empresa mayor en múltiples razones sociales
menores, con el único propósito de eludir las exigencias de la reorganización ordinaria ---en
particular la auditoría del \art{56}---. Es una aplicación concursal del control del abuso de la
personalidad jurídica.\verificar{Individualizar los primeros fallos que aplican el criterio de
unidad económica y rechazan la fragmentación artificial en la reorganización simplificada.}

\begin{foco}[La simplificación es para la empresa pequeña, no para la disfrazada de pequeña]
El acceso al procedimiento simplificado se calibra por la realidad económica, no por la forma
societaria. Partir una empresa mediana en varias micro para acogerse a la vía simplificada ---y
evitar la auditoría--- es un fraude a la ley que el tribunal puede detectar en la admisibilidad. La
defensa del acreedor que enfrenta esa maniobra es acreditar la unidad económica subyacente.
\end{foco}
