...
auditor externo puede representar un desembolso del orden de las \destacar{35 UF}, cifra
significativa para el presupuesto de una microempresa en crisis y muchas veces desproporcionada
respecto de la simplicidad de su contabilidad.\verificar{Confirmar el orden de magnitud del costo
de la auditoría externa (referencia de trabajo: 35 UF).} La contrapartida es un traslado de
riesgo. Lo que un auditor habría filtrado antes de presentar, ahora lo controlará ---o lo
