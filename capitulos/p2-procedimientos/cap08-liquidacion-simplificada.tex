...
A ese catálogo se suma un límite \destacar{temporal} propio del concurso: el \art{276} restringe el
embargo sobre el exceso de la remuneración del deudor (por sobre las 56 UF, capítulo
\ref{cap:liquidacion-ordinaria}) a un plazo máximo \destacar{no prorrogable de tres meses} contado
desde la resolución de liquidación. Vencido ese plazo, todo ingreso posterior queda liberado para
asegurar la subsistencia del concursado. Las pensiones de jubilación e invalidez, por su parte, no
ingresan a la masa: su inembargabilidad emana de la legislación de seguridad social y del
\artcc{1618} \Nro 1.
...
antijurídica que da lugar a la tercería, a la restitución y a la responsabilidad del liquidador. Lo
mismo vale para el exceso de remuneración retenido más allá de los tres meses del \art{276}. La
...
\subsection{Denegación del \discharge{} por mala fe e imposibilidad del discharge parcial}

Conviene distinguir dos cuestiones que la práctica confunde. La primera es la
\destacar{denegación por mala fe}: desde la vigencia de la \Lreforma{} (mayo de 2023), los juzgados
civiles ---señaladamente de Santiago, Concepción y Valparaíso--- han exigido, para acoger el
incidente del \art{169 A}, que el incidentista acredite \destacar{fehacientemente} maniobras
fraudulentas del deudor orientadas a sustraer activos de la masa o a abultar el pasivo. Acogido el
incidente, el deudor pierde el beneficio de la extinción de saldos y el procedimiento continúa como
ejecución concursal ordinaria, sin liberación.

La segunda es la \destacar{imposibilidad de un \emph{discharge} parcial} de fuente judicial. Los
tribunales han rechazado que el juez pueda graduar la extinción según la capacidad de pago residual
del deudor: la descarga del \art{255} es de naturaleza \destacar{binaria e indivisible}, opera por
el solo ministerio de la ley sobre la totalidad de las obligaciones preexistentes ---salvo las
exceptuadas por texto expreso (alimentos, delitos, CAE por especialidad)--- y el juez carece de
facultad para fijar porcentajes de exoneración. La única graduación admisible es la del propio
\art{169 A}, que faculta a denegar total o \emph{parcialmente} la extinción \destacar{por mala fe},
no por insuficiencia de pago.\verificar{Individualizar las resoluciones de juzgados civiles que
aplican el art. 169 A y las que rechazan el discharge parcial de fuente judicial.}

\begin{foco}[Dos cosas distintas que la práctica confunde]
Que la descarga sea binaria \emph{no} contradice la denegación parcial del \art{169 A}. La
diferencia es la \emph{causa}: el juez no puede recortar la descarga porque el deudor «podría pagar
algo» ---eso sería un discharge parcial de capacidad, inexistente en Chile---, pero sí puede
denegarla en parte cuando la \emph{gravedad de la mala fe} lo justifica. La capacidad de pago no es
criterio; la probidad, sí.
\end{foco}
