...
\centering
\small
\caption{Evolución de las solicitudes concursales de la persona deudora}
\label{tab:cap06-estadisticas}
\begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{0.34\textwidth} p{0.18\textwidth} p{0.18\textwidth} X@{}}
\toprule
\textbf{Métrica} & \textbf{Anual 2025} & \textbf{Primer trim.\ 2026} & \textbf{Variación} \\
\midrule
Renegociaciones de persona deudora & 4.815 solicitudes & 1.818 solicitudes
& $+$146\,\% en 2025 \\
\addlinespace
Participación de emisores de boletas & 72{,}0\,\% & 73{,}9\,\% & Consolidación tras la reforma \\
\addlinespace
Tasa de acuerdos (efectividad) & 95{,}0\,\% & 97{,}0\,\% & Evita la liquidación forzosa \\
\addlinespace
Liquidaciones simplificadas de personas & 6.756 procedimientos & 1.870 procedimientos
& $+$45\,\% en 2025 \\
\addlinespace
Participación de mujeres (renegociación) & 45{,}9\,\% & 55{,}7\,\% & Desplazamiento demográfico \\
\bottomrule
\end{tabularx}
\end{table}

\verificar{Contrastar todas las cifras contra el boletín estadístico oficial de la \superir{}
a la fecha de cierre de la edición.}

Un segundo grupo de indicadores describe el \destacar{comportamiento en las audiencias}. La
asistencia a la audiencia de determinación del pasivo bordea el 99\,\% y la de renegociación se
mantiene sobre el 98\,\%, mientras que la audiencia de ejecución ---que sólo se celebra cuando
fracasa la renegociación--- se activa en menos del 7\,\% de los casos.\verificar{Cifras de
trabajo por confirmar contra el boletín SUPERIR: asistencia 99{,}4\,\% (determinación),
98{,}5\,\% (renegociación) y activación de la audiencia de ejecución en 6{,}7\,\% de los
procedimientos.} La lectura es nítida: la inmensa mayoría de los procedimientos se resuelve por
acuerdo en las dos primeras audiencias, y la ejecución opera como válvula residual.

En el plano territorial, las solicitudes se concentran de manera acusada en la
\destacar{Región Metropolitana}, lo que refleja tanto la densidad poblacional como la brecha de
cobertura del procedimiento en regiones ---un dato relevante para el diseño de la política
pública de acceso.\verificar{Confirmar el porcentaje de concentración en la Región Metropolitana
según el boletín estadístico de la \superir{}.}

\begin{foco}[Qué dicen los números sobre el procedimiento]
Cuatro lecturas. Primera: la inclusión de los honorarios no fue marginal ---explica cerca de tres
de cada cuatro solicitudes---. Segunda: la efectividad es altísima (95-97\,\% de acuerdos), lo
que confirma que la renegociación cumple su función de evitar la liquidación. Tercera: el
crecimiento del uso femenino sugiere que el procedimiento está alcanzando a un segmento que el
sistema anterior no atendía. Cuarta: la altísima asistencia a las dos primeras audiencias y la
escasa activación de la de ejecución muestran que el diseño desjudicializado funciona en la
práctica. Fue este volumen el que motivó la dictación de la \ncg{28} \citeyearpar{ncg-28} para
precisar y agilizar los criterios de admisibilidad.
\end{foco}
