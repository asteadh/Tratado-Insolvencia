...
\paragraph{El \emph{StaRUG}: el marco de reestructuración preventiva.} La transposición de la
Directiva \parencite{ue-directiva-2019-1023} se hizo en Alemania mediante una ley autónoma, el
\destacar{\emph{StaRUG}} (\emph{Unternehmensstabilisierungs- und -restrukturierungsgesetz}), en
vigor desde el \destacar{1 de enero de 2021}. Crea un marco de reestructuración
\emph{preconcursal} ---fuera del \emph{Insolvenzverfahren}--- para el deudor en insolvencia
inminente, con un plan de reestructuración votado por clases y arrastre entre ellas, y una
suspensión de ejecuciones de duración limitada. Es el instrumento alemán equivalente al
\emph{restructuring plan} inglés y a los planes de reestructuración españoles. Su texto vigente ---confirmado en \emph{gesetze-im-internet.de} el 25 de
julio de 2026--- data del 22 de diciembre de 2020, rige desde el 1 de enero de 2021 y fue modificado
por última vez el 15 de julio de 2024.
...
\paragraph{Las clases de partes afectadas.} La transposición de la Directiva ---por la
\destacar{ordonnance n.\textsuperscript{o} 2021-1193, de 15 de septiembre de 2021}, en vigor desde
el 1 de octubre de 2021 (confirmada en Legifrance al 25-07-2026)--- sustituyó los comités de
acreedores por las \emph{classes de parties affectées} e introdujo el arrastre forzoso entre clases
(\emph{cross-class cram-down}, art. L. 626-32 del Código de Comercio), morigerando el tradicional
poder del juez francés de imponer el plan.
...
reforma de la \emph{Corporate Insolvency and Governance Act} (CIGA) de \destacar{2020} ---la
\emph{Public General Act} c.\,12 de 2020, vigente según legislation.gov.uk al 25 de julio de
2026---, que añadió el \emph{restructuring plan} de la Parte 26A de la \emph{Companies Act} y un
moratorio autónomo--- ofrece el modelo más flexible, menos judicializado y más orientado al
mercado. Sus instrumentos centrales:
