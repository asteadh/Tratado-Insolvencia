...
resultaba inalcanzable para la empresa pequeña. El umbral de pasivo elegible fluctúa: el aumento
transitorio a \textsc{us}\$7,5 millones (contingencia sanitaria) expiró el 21 de junio de 2024, de
modo que desde el \destacar{22 de junio de 2024} rige el límite reexpresado por inflación de
\textsc{us}\$3.024.725 (11 \textsc{u.s.c.} § 1182), confirmado en uscourts.gov al 25 de julio de
2026. Los parámetros del \emph{means test} se actualizan semestralmente.\verificar{Reconfirmar el
umbral del Subchapter V y las medianas del means test antes de imprimir, pues se ajustan
periódicamente.}
