...
resultaba inalcanzable para la empresa pequeña.\verificar{El umbral de pasivo elegible del
\emph{Subchapter V} y los parámetros del \emph{means test} se ajustan periódicamente (y el umbral
elevado transitorio ha fluctuado): confirmar las cifras vigentes en uscourts.gov antes de citar
montos; por eso el texto los trata cualitativamente. Dato al 25-07-2026.}
