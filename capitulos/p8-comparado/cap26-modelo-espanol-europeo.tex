...
El hito decisivo es la \destacar{Ley 16/2022, de 5 de septiembre} \parencite{esp-ley16-2022}, que
transpuso la Directiva europea sobre reestructuración e insolvencia y reconfiguró tanto el
instrumento preventivo como la segunda oportunidad de la persona natural.\verificar{Confirmar en el
BOE la vigencia y las eventuales modificaciones posteriores del TRLC (2020) y de la Ley 16/2022 al
cierre de edición; dato al 25-07-2026.}
...
\paragraph{El crédito público.} La ley limita la exoneración del crédito público a un máximo de
\destacar{diez mil euros por cada entidad} ---Hacienda y Seguridad Social---, con una estructura de
tramos: exoneración \emph{total} de los primeros \destacar{cinco mil euros} y del
\destacar{50\,\%} del tramo entre 5.001 y 10.000; el exceso sobre diez mil euros es inderogable y
debe solventarse mediante un plan de pagos a cinco años.\verificar{Cotejar los umbrales vigentes
del crédito público exonerable tras las modificaciones posteriores a la Ley 16/2022.}
