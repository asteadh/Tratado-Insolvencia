...
La \ley{4.558} \citeyearpar{ley-4558} ---promulgada el 29 de enero de 1929 y publicada en el
\emph{Diario Oficial} el \destacar{4 de febrero de 1929}, con texto refundido fijado por el
D.F.L. N.\textsuperscript{o} 248 de 1931--- introdujo un cambio de arquitectura institucional cuya
importancia excede su contenido normativo. Sistematizó las quiebras \destacar{fuera del Código de
Comercio} de 1865, \destacar{unificó el tratamiento de comerciantes y no comerciantes} ---superando
la restricción subjetiva del concurso al deudor mercantil--- y profesionalizó la administración del
concurso mediante la creación de la \destacar{Sindicatura General de Quiebras}, sometiendo al
síndico a un régimen de control público. Con ello se reconoció, por primera vez de manera
explícita, que la administración de un patrimonio en crisis es una función de interés general y no
un asunto privado entre deudor y acreedores.

\subsubsection{La Ley \Nro 18.175 y su incorporación al Código de Comercio}

La \ley{18.175} \citeyearpar{ley-18175}, de 1982, constituyó el estatuto concursal aplicable en
Chile durante más de tres décadas. Su rasgo distintivo fue el desplazamiento hacia un modelo de
\destacar{administración privada} de la quiebra: sustituyó la sindicatura estatal por un sistema de
\destacar{síndicos privados sometidos a fiscalización pública} ---primero de la Fiscalía Nacional
de Quiebras y luego de la Superintendencia de Quiebras, antecesora institucional de la actual
\superir{}---. Posteriormente, su articulado fue incorporado como Libro \textsc{iv} del \ccom{},
consolidando formalmente la naturaleza mercantil del instituto.\verificar{Confirmar la ley y el año
que incorporaron el texto de la Ley 18.175 como Libro IV del Código de Comercio.}
...
\subsubsection{La \emph{ratio legis} en la historia de la ley}

La voluntad del legislador, tal como consta en la historia de ambas leyes conservada por la
\textsc{bcn} \parencite{historia-ley-20720, historia-ley-21563}, confirma y precisa esta lectura.

El \destacar{mensaje de la Ley 20.720} parte de un diagnóstico explícito: la legislación
anterior ---vigente por más de tres décadas--- se había vuelto anacrónica; en ella la
reorganización y el salvataje no eran el propósito general del legislador, y aun la liquidación
estaba sometida a trabas sistémicas carentes de justificación práctica. De ahí el giro nominal y
sustantivo: una «ley de reorganización y liquidación» que sitúa el salvataje de la empresa viable
como finalidad primera y trata la liquidación como \lat{ultima ratio}.

El \destacar{mensaje de la Ley 21.563} descansa en un dato empírico decisivo: los procedimientos
de reorganización de micro y pequeñas empresas representaban apenas cerca del \destacar{14\,\%}
del total, precisamente por la elevada carga presupuestaria que el procedimiento ordinario les
imponía. La creación de los procedimientos simplificados no fue, pues, una preferencia
ideológica, sino la corrección de una falla de acceso documentada en las cifras.

\begin{foco}[Por qué importa la historia de la ley al interpretar]
Cuando el texto de la ley es ambiguo ---y lo es en varios puntos críticos, del CAE a la mala
fe--- la historia fidedigna de su establecimiento es un criterio hermenéutico de primer orden. El
mensaje revela la finalidad: conservar la empresa viable, ampliar el acceso, reducir el costo. Un
argumento que se apoya en esa finalidad, contrastada con la historia de la ley, pesa más ante el
tribunal que la mera literalidad.
\end{foco}
