...
una carta de cobranza y una notificación judicial.\verificar{Precisar el alcance exacto
de la causal de inadmisibilidad por ejecuciones notificadas en el texto vigente.}
\end{alerta}
...
\begin{cuestionario}[Admisibilidad]
  ...
  {La admisibilidad exige un número mínimo de deudas vencidas, un umbral en UF y una
  antigüedad mínima del incumplimiento.}
  ...
  {Existen restricciones temporales para reiterar procedimientos.\verificar{Precisar los
  plazos de espera aplicables.}}
\end{cuestionario}
