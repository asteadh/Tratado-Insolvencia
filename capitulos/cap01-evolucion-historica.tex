...
1865 y que perfeccionaron sucesivamente la \ley{4.558} y la \ley{18.175} concebía la
quiebra como un episodio esencialmente patológico y reprochable: el comerciante que
...
económica, y la función del ordenamiento no consiste en castigar al que la sufre, sino
en administrar sus consecuencias de manera que se preserve el valor todavía existente y
...
La \ley{4.558} introdujo un cambio de arquitectura institucional cuya importancia
...
La \ley{18.175} constituyó el estatuto concursal aplicable en Chile durante más de tres
décadas. Su rasgo distintivo fue el desplazamiento parcial hacia un modelo de
...
La \LIR{} derogó el régimen anterior y sustituyó la lógica del sistema. Sus innovaciones
estructurales pueden sistematizarse en cinco:
...
\begin{enumerate}
  ...
  patrimonial universal e ilimitada del \artcc{2465}.
\end{enumerate}

\subsubsection{La reforma de la Ley \Nro 21.563}

La \Lreforma{} no sustituyó el sistema de 2014, sino que corrigió sus disfunciones
operativas. El diagnóstico legislativo que la precedió identificó un problema central:
...
verificación previa. Estas materias se desarrollan en los capítulos
...
dentro de cada categoría. El sistema de preferencias del \artcc{2472} subsiste
...
El ordenamiento chileno no define la insolvencia. La \LIR{} la presupone, la emplea como
criterio de apertura y la asocia a hipótesis de hecho tasadas, pero no la conceptualiza.
...
\begin{enumerate}
  ...
  El umbral de la \Lpyme{} determina el acceso a los procedimientos simplificados.
...
\paragraph{\sentencia{Corte Suprema}{15.988-2013}{2013}.}
...
Para la profundización de las materias tratadas se recomienda el examen de las fuentes
sistematizadas en la bibliografía general, y en particular las relativas a la evolución
del sistema concursal y al modelo de \discharge{} \autocite{academiajudicial-ley20720,
estadodiario-discharge, dictum-nuevosaires}.
