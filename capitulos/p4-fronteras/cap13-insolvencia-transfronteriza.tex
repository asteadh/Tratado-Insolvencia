...
\midrule
Elimco Soluciones Integrales & Juzgado Civil de Santiago, Rol C-2121-2016; España
...
\addlinespace
Astaldi SpA & 19.\textsuperscript{o} Juzgado Civil de Santiago, Rol C-1823-2019;
...
\addlinespace
LATAM Airlines Group & 2.\textsuperscript{o} Juzgado Civil de Santiago, Rol C-8553-2020; EE.UU.\
(Cap.\ 11) & Solicitud el 01-06-2020; oposición de acreedores por competencia y por el \art{301}
(COMI en Santiago); reconocimiento como \destacar{procedimiento principal} (COMI en Nueva York),
con administrador local bajo la \superir{}; apelaciones ante la \ca{Santiago} Roles 9476-2020 y
9475-2020 \\
\bottomrule
\end{tabularx}
\end{table}

\verificar{Roles de primera instancia cotejados contra la sistematización de la práctica chilena;
las fechas y el estado procesal de cada caso deben confirmarse contra los expedientes del Poder
Judicial (Oficina Judicial Virtual) antes de publicar. El estado del caso Ónix/Chang
(Rol C-22090-2016) queda pendiente de confirmación.}
