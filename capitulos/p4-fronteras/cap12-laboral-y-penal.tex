...
plataforma electrónica de la \dt{} mediante \destacar{firma electrónica avanzada}
\parencite{instructivo-i6}, aprobado por Resolución Exenta N.\textsuperscript{o} 16.245 de 4 de
noviembre de 2024.
...
El \artcdt{163 bis} \Nro 5 fija el estatuto del finiquito concursal con reglas propias. El
liquidador debe ponerlo a disposición del trabajador \destacar{a lo menos diez días antes de
expirar el período de verificación ordinaria de créditos}, y debe acompañarlo al tribunal dentro de
los \destacar{dos días} siguientes a su suscripción. Su autorización por ministro de fe ---notario
o Inspector del Trabajo--- procede \destacar{aun cuando las cotizaciones previsionales se
encuentren impagas}, lo que constituye una excepción deliberada a la regla laboral común. Y, sobre
todo, el finiquito suscrito vale como \destacar{verificación suficiente} de los créditos por
remuneraciones, asignaciones compensatorias e indemnizaciones que consten en él, y como antecedente
documentario bastante para un \destacar{pago administrativo} del \art{244}. Si el trabajador hace
\emph{reserva de acciones} al suscribirlo, la verificación o el pago administrativo quedan
limitados a las cantidades aceptadas.

\begin{alerta}[Suscribir el finiquito no es cobrar]
El finiquito habilita el pago administrativo, pero no lo garantiza en una fecha determinada: el
plazo que la \dt{} aplica ordinariamente para el pago de los finiquitos suscritos en la plataforma
\destacar{no resulta vinculante en sede concursal}, porque el cobro efectivo se sujeta al estado de
realización de los activos de la masa. Conviene advertirlo al trabajador al momento de la firma,
para no generar una expectativa de pago inmediato que el procedimiento no puede cumplir.
\end{alerta}
...
El \artcdt{163 bis} termina la relación laboral por el solo ministerio de la ley al dictarse la
resolución de liquidación, incluso respecto de trabajadores aforados: el fuero no impide el
término, sino que se traduce en el pago de la indemnización correspondiente. Sobre la
\destacar{nulidad del despido} (Ley Bustos), la clave es que el \artcdt{163 bis} \Nro 1 se aplica
«de forma preferente» al \artcdt{162} y excluye su efecto de convalidación: la sanción no rige en
el término concursal, por texto expreso. La jurisprudencia de unificación de la Cuarta Sala
---\rol{40.689-2016}, \rol{66.235-2021} (\emph{Rioseco con \textsc{efe}}) y \rol{139.538-2022}
\parencite{juris-cs-40689-2016, juris-cs-66235-2021, juris-cs-139538-2022}--- precisa los contornos
de la Ley Bustos \emph{en el despido común} (compatibilidad con el autodespido, cotizaciones sobre
horas extraordinarias, requisitos copulativos de la convalidación), no el límite concursal, que es
legal. El desarrollo detallado está en el capítulo \ref{cap:laboral-efectos}.

\subsection{Responsabilidad de gerentes y directores}

El \art{463 quáter} del \cpen{} extiende la responsabilidad penal por los delitos concursales a
quienes dirigen o administran los negocios del deudor ---directores, administradores de hecho o de
derecho y gerentes--- que ejecuten o autoricen expresamente las conductas típicas. La hipótesis más
frecuente es la \destacar{distracción de activos en los meses previos} a la apertura del concurso:
transferencias injustificadas, enajenaciones a personas relacionadas o constitución de garantías
sobre deudas preexistentes.

El caso \falloc{Ónix Capital / Chang Rajii}{C-22090-2016}, tramitado ante el 15.\textsuperscript{o}
Juzgado Civil de Santiago \parencite{juris-chang-onix}, ilustra la dimensión transfronteriza del
fenómeno. El liquidador chileno acreditó que el deudor había realizado \destacar{transferencias
electrónicas masivas e injustificadas hacia cuentas en el extranjero} en los meses anteriores a la
liquidación, y obtuvo el reconocimiento del procedimiento chileno como principal ante tribunales de
Estados Unidos, Malta y jurisdicciones del Caribe, lo que permitió congelar y repatriar bienes
raíces y depósitos a la masa nacional por la vía de las acciones revocatorias y paulianas coordinadas
entre foros (capítulo \ref{cap:transfronteriza}).\verificar{Cotejar el estado procesal y las
medidas del expediente C-22090-2016 en la Oficina Judicial Virtual.}

\begin{practica}[El rastro del dinero cruza fronteras, y la acción también]
La distracción de activos hacia el exterior en vísperas del concurso no es un límite para el
liquidador diligente: el Capítulo VIII permite pedir el reconocimiento del procedimiento chileno en
la jurisdicción de destino y coordinar el congelamiento de los bienes. Documentar las
transferencias del período sospechoso y actuar rápido ante los foros extranjeros es la diferencia
entre recuperar y perder el activo fugado.
\end{practica}
