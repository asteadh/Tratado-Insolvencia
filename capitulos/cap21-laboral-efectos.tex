...
La \csup{}, mediante sucesivos fallos de unificación de jurisprudencia, ha zanjado que los
efectos pecuniarios de esa nulidad \destacar{tienen como límite temporal la fecha de dictación
de la resolución de liquidación} del empleador. El fundamento es doble: el principio de
especialidad, y el hecho de que, decretada la liquidación, opera el \desasimiento{}, de modo
que ni el deudor ni el liquidador pueden continuar la administración ordinaria ni el pago
directo de remuneraciones fuera del procedimiento concursal de reparto.\verificar{Individualizar
los roles de los fallos de unificación de la Corte Suprema que fijan este límite.}
...
las remuneraciones por nulidad se devengan sólo hasta esa fecha, no hasta la convalidación.
Calcularlo mal ---proyectando la sanción más allá de la liquidación--- infla el crédito y
