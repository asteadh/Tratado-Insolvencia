...
concursal.\pendiente{Desarrollar el concurso especial de los acreedores hipotecarios y la
concurrencia de la primera clase sobre los bienes hipotecados.}
...
\toprule
\textbf{Crédito} & \textbf{Clase} & \textbf{Observaciones} \\
\midrule
Remuneraciones devengadas & Primera clase & Sujetas al tope legal por trabajador \\
\addlinespace
Asignaciones familiares & Primera clase & — \\
\addlinespace
Cotizaciones previsionales y de salud & Primera clase & Retenidas y no enteradas: régimen
propio y responsabilidades autónomas \\
\addlinespace
Feriado proporcional y pendiente & Primera clase & Se devenga hasta la fecha del término \\
\addlinespace
Indemnización sustitutiva del aviso previo & Primera clase & Tope legal en unidades de
fomento \\
\addlinespace
Indemnización legal por años de servicio & Primera clase & Tope expresado en ingresos
mínimos mensuales por año de servicio \\
\addlinespace
Indemnizaciones convencionales & Primera clase hasta el tope; el exceso, valista
& El exceso sobre el tope pierde la preferencia \\
\addlinespace
...
\verificar{Confirmar cada tope contra el texto vigente del artículo 2472 del Código Civil
y del Código del Trabajo: monto en UF de la indemnización sustitutiva, número de ingresos
mínimos por año de servicio y tope de años computables.}
