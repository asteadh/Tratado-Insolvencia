...
\begin{checklist}[Barrido documental completo]
  ...
  \item Verificación de procedimientos concursales anteriores: una resolución de término de
  liquidación firme impide una nueva liquidación voluntaria durante cinco años
  (\art{273 B}).
\end{checklist}

\begin{alerta}[El plazo de espera de cinco años]
Antes de aceptar el encargo debe descartarse que el cliente haya obtenido el término de una
liquidación en los últimos cinco años. Una solicitud presentada dentro de ese plazo es
inadmisible por mandato del \art{273 B}, y la revisión llega tarde si se hace después de
presentar.
\end{alerta}
