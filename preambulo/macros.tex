...
\newcommand{\ctrib}{Código Tributario\index[leyes]{Código Tributario}}
...
\newcommand{\artcpc}[1]{artículo~#1 del \cpc}
\newcommand{\dl}[1]{D.L.~\Nro#1\index[leyes]{Decreto Ley #1@D.L.~\Nro#1}}
% \artir{art}{numeral}: artículo N.º de la Ley sobre Impuesto a la Renta
\newcommand{\artir}[2]{artículo~#1 \Nro#2 de la Ley sobre Impuesto a la Renta%
  \index[leyes]{Ley sobre Impuesto a la Renta}}
