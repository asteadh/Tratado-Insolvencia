...
\newcommand{\verificar}[1]{%
  \ifMostrarVerificaciones
    \marginnote{\raggedright\footnotesize\sffamily\color{ColorAcento}\textbf{Verificar:} #1}%
  \fi}
\newcommand{\pendiente}[1]{%
  \ifMostrarVerificaciones
    \marginnote{\raggedright\footnotesize\sffamily\color{ColorGris}\textbf{Pendiente:} #1}%
  \fi}
